...
const playersData = [
    ...
    // CORINTHIANS (sem Romero e Matheus Pereira)
...
function setupEventListeners() {
    ...
    document.getElementById("filterClubBtn")?.addEventListener("click", () => openFilterModal("clubFilterModal"));
    ...
    document.getElementById("filterCountryBtn")?.addEventListener("click", () => openFilterModal("countryFilterModal"));
    ...
    document.getElementById("filterValueBtn")?.addEventListener("click", () => openFilterModal("valueFilterModal"));
    ...
    // Botão de filtro por posição (NOVO)
    document.getElementById("filterPositionBtn")?.addEventListener("click", () => openFilterModal("positionFilterModal"));
    document.querySelectorAll("#positionFilterList .filter-option").forEach(opt => {
        opt.addEventListener("click", () => { 
            currentPositionFilter = opt.dataset.position; 
            currentClubFilter = "all"; 
            currentCountryFilter = "all";
            currentValueRange = "all";
            renderPlayersList(); 
    ...
    // Fechar modais
    document.querySelectorAll(".close-modal, .close-formation, .close-club, .close-country, .close-value, .close-position").forEach(btn => {
    ...
    // Buscas
    document.getElementById("playerSearchInput")?.addEventListener("input", (e) => renderPlayersList(e.target.value));
